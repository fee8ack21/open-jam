/* ============================================================
   June — Checkout view
   cart · buyer info (name + email) · credit card · validation
   ============================================================ */
(function () {
  window.CheckoutView = {
    name: 'CheckoutView',
    components: { ProductThumb: window.ProductThumb, JIcon: window.JIcon },
    ...
    computed: {
      items() { return this.store.getters.cartProducts; },
      subtotal() { return this.store.getters.subtotal; },
      ...
      <div class="page page-pad" data-screen-label="結帳頁">
        ...
        <div v-if="order" class="success-wrap">
            ...
            <div v-for="it in order.items" :key="it.id" class="cart-item">
              ...
              <div class="cart-item-body">
                ...
                <div class="cart-item-foot">
                  <span style="font-size:12.5px; color:var(--text-faint); font-family:var(--june-mono)">{{ it.formats.join(' · ') }}</span>
          ...
          <div style="display:flex; gap:12px; margin-top:24px; justify-content:center;">
            <n-button size="large" @click="store.goList()">繼續探索</n-button>
        ...
        <div v-else-if="!items.length" class="empty">
          ...
          <n-button type="primary" style="margin-top:18px" @click="store.goList()">去逛逛</n-button>
        </div>
